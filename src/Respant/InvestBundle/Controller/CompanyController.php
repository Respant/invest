...
use Respant\InvestBundle\Entity\Company;
...
class CompanyController extends Controller
{
    ...
    {
        $company = new Company();
        $form = $this->createForm('Respant\InvestBundle\Form\CompanyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('Respant\InvestBundle\Form\CompanyType', $company);
