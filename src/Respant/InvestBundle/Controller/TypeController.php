...
use Respant\InvestBundle\Entity\Type;
...
class TypeController extends Controller
{
    ...
    {
        $type = new Type();
        $form = $this->createForm('Respant\InvestBundle\Form\TypeType', $type);
    ...
    {
        $deleteForm = $this->createDeleteForm($type);
        $editForm = $this->createForm('Respant\InvestBundle\Form\TypeType', $type);
